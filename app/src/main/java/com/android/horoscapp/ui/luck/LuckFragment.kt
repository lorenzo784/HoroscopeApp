...
import com.android.horoscapp.ui.core.listeners.OnSwipeTouchListener
import com.android.horoscapp.ui.horoscope.HoroscopeViewModel
import com.android.horoscapp.ui.model.LuckyModel
import com.android.horoscapp.ui.providers.RandomCardProvider
...
class LuckFragment : Fragment() {
    ...
    private fun preparePrediction() {
        ...
        currentLuck?.let { luck ->
            val currentPrediction = getString(currentLuck.text)
            binding.tvLucy.text = currentPrediction
            binding.ivLuckyCard.setImageResource(currentLuck.image)
